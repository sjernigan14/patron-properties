# Patron Properties — Master Demo Universe
## The Complete Cast, Properties & Journeys
### Last Updated: 2026-04-07

---

## THE 10 PROPERTIES (Patron Portfolio — Masters 2027)
...
**Key screens**: B-03 (Portal — sees seasonal cycle), B-02 (Pricing — validated her rate), A-04 (her deal appears in pipeline)
...
**Key screens**: A-01 (was a prospect), B-01 (intake), B-02 (pricing convinced them), B-03 (portal — checks obsessively), B-05 (post-event damage report was their #1 concern)
...
**Key screens**: B-01 (intake — fast), B-03 (portal — checks quarterly), B-02 (pricing — negotiated hard on rate)
...
**Key screens**: B-01 (Amy completed), B-03 (Amy manages), B-02 (compared Patron's pricing to what they got listing independently — Patron was +$400/nt higher due to corporate demand)
...
**Key screens**: A-01 (prospect card), A-04 (deal in "Contract" stage, stale 12 days), B-01 (started intake, saved at step 3), B-02 (the screen that almost closed them)
**Personality**: Need to hear from other homeowners. A testimonial from Margaret Ashford would close them.
...
### Homeowner Journey (Full Lifecycle)
```
PROSPECT → FIRST CONTACT → PROPERTY VISIT → PRICING REVIEW → CONTRACT → INTAKE COMPLETE
    ↓            ↓                ↓                ↓              ↓            ↓
  A-01         A-01            A-04             B-02           A-05         B-01

→ SEASONAL PREP → FINAL PREP → LOAD-IN/STAGING → TOURNAMENT WEEK → POST-EVENT → PAYOUT → RE-ENROLL
       ↓              ↓              ↓                 ↓              ↓           ↓          ↓
